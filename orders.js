...
const ticket1 = new Ticket(['banana', 'bread'], '2023-12-09 2:30 PM', '345');
console.log(ticket1); // Check the initial state of the ticket
  
ticket1.updateStatus('in progress');
// Output: The order for customer 12345 is now in progress.
console.log(ticket1); // Check the updated state of the ticket
...
firstTicket = new Ticket(['pizza', 'bread', 'soda'], '2023-12-09 7:03 PM', '575');
